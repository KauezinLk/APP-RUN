...
class Participante(models.Model):
    # Cria uma coluna e umachave estrangeira para o modelo Corrida, estabelecendo uma relação muitos-para-um.
...
class ResultadoImagem(models.Model):
    table = models.FileField('Arquivo de Resultados', upload_to='resultados/')
    ArquivoResultado = models.ForeignKey('Produto', related_name='products', on_delete=models.CASCADE) 
